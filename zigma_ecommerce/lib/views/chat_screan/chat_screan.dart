...
import 'package:zigma_ecommerce/controllers/chats_controller.dart';
import 'package:zigma_ecommerce/services/firestore_services.dart';
import 'package:zigma_ecommerce/views/chat_screan/components/sender_bubble.dart';
          ...
          children: [
            Obx(
              () => controller.isLoading.value
                  ...
                  : Expanded(
                      child: StreamBuilder(
                          stream: FireStroreServices.getChatMessages(
